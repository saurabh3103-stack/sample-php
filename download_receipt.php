                        ...
                        <div class="main">
                            <div class="container_12">
                                <article class="grid_12">
                                    <nav>
                                        <ul class="menu">
                                            <li class="first"><a class="" href="index.php">Home<span></span></a></li>
...
.margin-bot5 {
     margin-bottom: 0px;
                            ...
                            <div class="wrapper margin-bot11">
                            	...
                            	<article class="grid_8" style="background-color:#FFFFFF;">
                                <div id="reciept_div">
                                	<div class="bg-6 border_r-2">
	                                    <h4 class="d-block indent-left3 indent-top3 text-light">Download Receipt</h4>
                                    </div>
                                    <figure>
                                     <div style="background-color:#FFFFFF; padding:15px;">
                                          <form method="POST" action="download_receipt.php">
                                      <b> Enter Receipt No.</b><br />
                                       <input type="text" name="rcpt" style="padding:5px;width:50%;" />
                                       <br /> <br />
                                       <input type="submit" class="button-5" value="Download PDF" style="cursor:pointer; margin-top:-10px;">
                                       </form>
                                     </div>
                                   </figure>
                                </article>
